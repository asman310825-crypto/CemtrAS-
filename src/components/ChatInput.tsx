...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <section 
      ...
      className="sticky bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t border-gray-200/50 dark:border-gray-700/50 shadow-2xl"
    >
          ...
          >
            {uploadedFiles.map((file) => (
              <div 
                ...
                className="flex items-center gap-2 sm:gap-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-xl px-3 sm:px-4 py-2 sm:py-3 backdrop-blur-sm"
              >
