        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-lg sm:rounded-xl md:rounded-2xl blur-sm opacity-50"></div>
              <div className="relative p-1 sm:p-1.5 md:p-2 lg:p-2.5 xl:p-3 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-lg sm:rounded-xl md:rounded-2xl shadow-xl">
                <Factory className="text-white w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7" />
              </div>
              <div className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-1 sm:gap-2 md:gap-3 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-white/80 dark:bg-gray-800/80 rounded-lg sm:rounded-xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg backdrop-blur-sm">
                <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 rounded-full overflow-hidden border-2 border-blue-500 shadow-lg">
                  <img 
